...
@if($errors->any())
    ...
    @endif
    <form method="post" id="form" action="{{route('user.update', $data)}}" enctype="multipart/form-data" style="margin:80px" >
        <div class="row">
                <h2 style="color:#334d4d; margin-left: 500px;">Update <b>User</b></h2>
            </div>
